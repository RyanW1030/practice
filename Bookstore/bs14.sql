...
insert  into `cart_item`(`id`,`user_id`,`book_id`,`count`) values (6,2,3,10),(7,2,4,4),(8,2,2,2),(9,2,16,1),(12,5,6,3),(13,5,16,1),(14,5,19,1),(15,2,18,1),(16,2,24,4),(17,2,28,3),(22,2,14,3);
...
insert  into `order_item`(`id`,`order_id`,`book_id`,`name`,`price`,`count`,`total_price`) values (5,'6a376bc569dd4e2ca845db79fb863718',9,'高性能MySQL（第4版）','128.00',1,'128.00'),(6,'6a376bc569dd4e2ca845db79fb863718',15,'人工智能：一种现代的方法（第4版）','198.00',4,'792.00');
...
insert  into `user_info`(`id`,`username`,`password`,`email`,`balance`,`address`,`phone`,`avatar`) values (2,'个别的十一人','12345678','ghost@gmail.com','1080.00','武汉理工大学','18888888888','/static/img/avatar/Batman.jpg'),(3,'GhostInTheShell','12345678','ghost@gmail.com','0.00',NULL,NULL,'/static/img/avatar/default.jpg'),(4,'Jupiter','11111111','Jupter@gmail.com','0.00',NULL,NULL,'/static/img/avatar/default.jpg'),(5,'Mars','12345678','Mars@gmail.com','0.00',NULL,NULL,'/static/img/avatar/default.jpg');
...
insert  into `user_order`(`order_id`,`create_time`,`total_money`,`status`,`user_id`,`receiver_address`,`receiver_phone`) values ('6a376bc569dd4e2ca845db79fb863718','2025-12-23 23:39:27','920.00',1,2,'武汉理工大学','18888888888');
...
insert  into `user_preference`(`user_id`,`category_id`) values (2,1),(2,5);
